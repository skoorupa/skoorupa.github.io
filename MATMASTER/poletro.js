...
MATMASTER.solve = MATMASTER.questFirst*MATMASTER.questSecond/2;
...
document.getElementsByTagName('b')[2].innerText = MATMASTER.cookie;
document.getElementsByTagName('b')[3].innerText = MATMASTER.suma;
...
MATMASTER.name = ["punktytro","sumatro",2,3];